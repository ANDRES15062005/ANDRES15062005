...
<ul class="list-disc pl-6 py-4 text-gray-700">
  <li>🔭 Actualmente estoy trabajando en un proyecto <strong>Ventas y Arriendo de inmuebles - Alimvida SAS</strong></li>
  <li>🌱 Actualmente estoy aprendiendo <strong>React JS || Typescript || Javascript || Tailwind CSS</strong></li>
  <li>👨‍💻 Todos mis proyectos están en <a href="https://github.com/ANDRES15062005?tab=repositories" class="text-blue-600 hover:text-blue-800">GitHub</a></li>
  <li>💬 Pregúntame sobre <strong>React JS || HTML || CSS || Boostrap || Javascript || Typescript</strong></li>
  <li>📫 ¿Cómo encontrarme? <strong>andresflorez15062005@gmail.com</strong></li>
</ul>

<h3 class="text-xl font-semibold text-left py-2 text-gray-800">Connect with me:</h3>
<p class="text-left space-x-4 text-gray-600">
...
<h3 class="text-xl font-semibold text-left py-2 text-gray-800">Languages and Tools:</h3>
<p class="text-left flex flex-wrap gap-4">
  <!-- Imágenes no afectadas, las dejo como estaban -->
